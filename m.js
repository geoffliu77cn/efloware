//Mutialisation V1.157 Xiaodong Liu ludovic.liu@gmail.com  16:00 01 JUl 2011
//Fix Value Inland Haulage display problems


/////////////////////////////////////////////////////////////////////////////////////////
//author Liu Xiaodong   ver 1.157                                                      //
			    ...
			    */
			    ...
			    if ($(this).attr('id') === "Inland_Haulage_40HQ") {
			        ...
			        if (_Final_price_40HQ > 0) {
			            ...
			            _Total_Delivery_Charge_40HQ = _Total_Delivery_Charge_40HQ + _value;
			            $(this).val((_value+_TypeTransport) + "Ä");
